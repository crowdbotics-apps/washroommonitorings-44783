...
## Project Structure
    ...
    ├── washroommonitorings_44783  # Django project configurations
...
1. Clone this repo and `cd washroommonitorings_44783`
...
2. Clone this repo and `cd washroommonitorings_44783`
